...
<body>
    ...
    <div class="container">
        ...
        <div class="actions">
            <a href="${pageContext.request.contextPath}/user/category/add" class="btn btn-success">Thêm Category mới</a>
            <a href="${pageContext.request.contextPath}/user/category/findall" class="btn" style="background-color: #17a2b8; color: white;">Tất cả Category User</a>
        </div>
            ...
            <tbody>
                <c:forEach var="category" items="${cateList}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/user/category/edit?id=${category.cateId}" 
                               class="btn btn-warning">Sửa</a>
                            <a href="${pageContext.request.contextPath}/user/category/delete?id=${category.cateId}" 
                ...
                <c:if test="${empty cateList}">
                    <tr>
                        <td colspan="4" style="text-align: center; color: #666;">
                            Bạn chưa tạo category nào. <a href="${pageContext.request.contextPath}/user/category/add">Tạo category đầu tiên</a>
                        </td>
                    </tr>
                </c:if>
            </tbody>
