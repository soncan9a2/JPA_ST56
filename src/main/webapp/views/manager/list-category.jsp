...
<body>
    <div class="header">
        <div>
            <h2>Manager - Quản lý Category</h2>
    ...
    <div class="container">
        ...
        <div class="actions">
            ...
            <a href="${pageContext.request.contextPath}/manager/category/findall" class="btn" style="background-color: #17a2b8; color: white;">Tất cả Category Manager</a>
        </div>
