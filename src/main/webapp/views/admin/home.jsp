...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-bottom: 20px; text-align: center;">
            <a href="${pageContext.request.contextPath}/admin/category/list" class="btn" style="background-color: #007bff; color: white; padding: 15px 30px; font-size: 16px; margin: 5px;">Quản lý Category Admin</a>
            <a href="${pageContext.request.contextPath}/admin/category/add" class="btn" style="background-color: #28a745; color: white; padding: 15px 30px; font-size: 16px; margin: 5px;">Thêm Category mới</a>
            <a href="${pageContext.request.contextPath}/admin/category/findall" class="btn" style="background-color: #17a2b8; color: white; padding: 15px 30px; font-size: 16px; margin: 5px;">Tất cả Category Admin</a>
        </div>
